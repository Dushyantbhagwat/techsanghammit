    ...
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-full">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white">Parking Management</h1>
        ...
        <div className="flex items-center gap-6 text-sm">
          <div className="flex items-center gap-2">
            <span className="font-medium text-gray-900 dark:text-white text-lg">12</span>
            <span className="text-gray-600 dark:text-gray-400">Filled</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-medium text-gray-900 dark:text-white text-lg">36</span>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        {/* Camera Feed Section */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 flex-1">
          <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Live Camera Feed</h2>
          <div className="relative w-full">
            <div className="aspect-video w-full max-w-[900px] mx-auto bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden">
              <img
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 xl:w-96 flex-shrink-0">
